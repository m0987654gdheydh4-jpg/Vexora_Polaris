...
public final class Outline360Renderer implements AutoCloseable {
    ...
    public static final RenderPipeline OUTLINE_360_PIPELINE = RenderPipeline.builder()
            .withLocation(id("pipeline/outline_360"))
            .withVertexShader(id("ui/shared/outline_quad"))
            .withFragmentShader(id("ui/outline_360/outline_360"))
            ...
            .withUniform("Outline360ParamsArray", com.mojang.blaze3d.shaders.UniformType.UNIFORM_BUFFER)
            .withUniform("Outline360RangesArray", com.mojang.blaze3d.shaders.UniformType.UNIFORM_BUFFER)
            .build();
    ...
    public void draw(GuiGraphics graphics, BuiltOutline360 outline) {
        beginFrame(graphics);
        enqueue(outline);
        flush();
    }
    ...
    private void submit(GuiGraphics graphics, BuiltOutline360 outline) {
        ...
        try {
            ...
            ((GuiGraphicsExtractorAccessor) graphics)
                    ...
                    .submitGuiElement(new Outline360RenderState(pose, normalized, ScissorUtil.current()));
        } catch (RuntimeException ignored) {
        }
    }
    ...
    private void ensureBuffers() {
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            paramsBuffer = RenderSystem.getDevice().createBuffer(
                    () -> "cataclysm_outline_360_params",
                    GpuBuffer.USAGE_UNIFORM,
                    paramsData
            );
            rangesBuffer = RenderSystem.getDevice().createBuffer(
                    () -> "cataclysm_outline_360_ranges",
                    GpuBuffer.USAGE_UNIFORM,
                    rangesData
            );
            paramsDirty = false;

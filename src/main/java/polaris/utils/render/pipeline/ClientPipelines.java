package polaris.utils.render.pipeline;
...
import polaris.utils.render.RenderLayerFactory;
...
public final class ClientPipelines {
    ...
    public static final RenderPipeline CRYSTAL_FILLED_TRIANGLES_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(MATRICES_PROJECTION_SNIPPET)
                    .withLocation("pipeline/crystal_filled_tri")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
    ...
    public static final RenderType CRYSTAL_FILLED_TRIANGLES = RenderLayerFactory.create("crystal_filled_tri", 8192, CRYSTAL_FILLED_TRIANGLES_PIPELINE);

    
    public static final RenderPipeline TARGET_LIGHTNING_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(MATRICES_PROJECTION_SNIPPET)
                    .withLocation("pipeline/target_lightning")
                    .withVertexShader("core/position_color")
                    .withFragmentShader("core/position_color")
                    .withBlend(worldBlend())
                    .withDepthTestFunction(DepthTestFunction.NO_DEPTH_TEST)
    ...
    public static final RenderType TARGET_LIGHTNING = RenderLayerFactory.create("target_lightning", 16384, TARGET_LIGHTNING_PIPELINE);
    ...
    public static final RenderPipeline WORLD_PARTICLES_COLOR_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.DEBUG_FILLED_SNIPPET)
                    .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "world_particles_color"))
                    .withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS)
                    .withCull(false)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
                    .withDepthWrite(false)
    ...
    public static final RenderPipeline WORLD_PARTICLES_LINES_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.DEBUG_FILLED_SNIPPET)
                    .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "world_particles_lines"))
    ...
    public static final RenderPipeline WORLD_PARTICLES_GLOW_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.GUI_TEXTURED_SNIPPET)
                    .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "world_particles_glow"))
                    .withVertexFormat(DefaultVertexFormat.POSITION_TEX_COLOR, VertexFormat.Mode.QUADS)
                    .withCull(false)
    ...
    public static final RenderPipeline TRAILS_ALPHA_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.DEBUG_FILLED_SNIPPET)
                    .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "trails_alpha"))
                    .withVertexFormat(DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS)
                    .withCull(false)
                    .withDepthTestFunction(DepthTestFunction.LEQUAL_DEPTH_TEST)
                    .withDepthWrite(false)

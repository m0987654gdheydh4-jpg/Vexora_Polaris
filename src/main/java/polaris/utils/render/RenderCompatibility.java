...
public final class RenderCompatibility {
    ...
    private static final String SAFE_WORLD_EFFECTS_PROPERTY = "cataclysm.safeWorldEffects";
    private static final String SAFE_WORLD_EFFECTS_ENV = "cataclysm_SAFE_WORLD_EFFECTS";

    private static Boolean disableFragEffectScanShader;
    private static String disableFragEffectScanShaderReason = "unresolved";
    private static final String DISABLE_FRAG_EFFECT_SCAN_PROPERTY = "cataclysm.disableFragEffectScanShader";
    private static final String DISABLE_FRAG_EFFECT_SCAN_ENV = "cataclysm_DISABLE_FRAG_EFFECT_SCAN_SHADER";

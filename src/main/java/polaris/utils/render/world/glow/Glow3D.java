package polaris.utils.render.world.glow;
...
public final class Glow3D {
    ...
    private static RenderPipeline pipelineNoDepth;
    ...
    public static void init() {
        ...
        pipeline = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "pipeline/world/glow3d"))
                .withVertexShader(Identifier.fromNamespaceAndPath("cataclysm", "world/glow3d/glow3d"))
                .withFragmentShader(Identifier.fromNamespaceAndPath("cataclysm", "world/glow3d/glow3d"))
        ...
        pipelineNoDepth = RenderPipeline.builder()
                .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "pipeline/world/glow3d_nodepth"))
                .withVertexShader(Identifier.fromNamespaceAndPath("cataclysm", "world/glow3d/glow3d"))
                .withFragmentShader(Identifier.fromNamespaceAndPath("cataclysm", "world/glow3d/glow3d"))
                .withVertexFormat(format, VertexFormat.Mode.TRIANGLES)
                .withUniform("Uniforms", UniformType.UNIFORM_BUFFER)
    ...
    public static void end() {
        ...
        try {
            ...
            try (RenderPass pass = encoder.createRenderPass(
                ...
                pass.setPipeline(ignoreDepth ? pipelineNoDepth : pipeline);

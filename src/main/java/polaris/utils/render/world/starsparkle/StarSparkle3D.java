package polaris.utils.render.world.starsparkle;
    ...
    public static void init() {
        ...
        try {
            ...
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.fromNamespaceAndPath("cataclysm", "pipeline/world/starsparkle"))
                    .withVertexShader(Identifier.fromNamespaceAndPath("cataclysm", "world/shared/particle_billboard"))
                    .withFragmentShader(Identifier.fromNamespaceAndPath("cataclysm", "world/starsparkle/starsparkle"))
